...
#define HOMING_BUMP_MM      { 5, 5, 2, 5, 2, 2, 2, 2}       // (linear=mm, rotational=°) 
                                                            // Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 2, 2, 2, 2, 2, 2 }       // Re-Bump Speed Divisor (Divides Homing Feedrate)
